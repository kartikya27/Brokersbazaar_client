...
<hr>
 ...
 <?php
        ...
        $_SESSION['orderDetails'] = $detailOforder;
            ...
            $date = $detailOforder->date;
            $orderID = $detailOforder->orderID;
            $orderAmt =  $detailOforder->amount;
          $orderdate =  $detailOforder->date;
    //   // ========   DONE  ============  
       ?>
                      ...
                      <tr>  
                                ...
                                <td class="text-center">
                                     ...
                                     <span class="view-order"><a href="javascript:void(0);" class="" data-toggle="modal" data-target="#<?php echo $orderID ?>" style="" data-more-info="1241">View Order</a></span>    								
                               </td>
                                <td >
    							 <div class="modal fade" id="<?php echo $orderID ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document" style="max-width:70%; margin-top:10%">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Order Detailed <b id="client-name"><?php echo $orderID; ?></b></h4>
