...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <td class="truncate"><?php echo $r->dob; ?> </td>
                        ...
                        <td><?php echo $r->city; ?></td>
                         ...
                         <!--<td><?php echo $r->state; ?></td>-->
                          <td><?php echo $r->addressVerificationStatus; ?></td>
                        <!--<td>Jodhpur, Rajasthan</td>-->
                      
                         
                        <td class="text-center"><button class="btn btn-danger btn-xs" onclick="deleteSingle(<?php echo $r->id;?>,'userbase')">Delete</button></td>
                    </tr> 
