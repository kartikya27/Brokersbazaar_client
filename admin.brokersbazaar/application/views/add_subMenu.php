...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <td><?php echo  $r->menu_category;?> </td>
                      ...
                      <td class="text-center"><a  data-toggle="modal" data-target="#edit<?php echo $r->id; ?>" class="btn btn-primary btn-xs"> Edit </a></td>
                        ...
                        <td class="text-center"><button class="btn btn-danger btn-xs" onclick="deleteSingle(<?php echo $r->id;?>,'subMenu')">Delete</button></td>
                    </tr> 
                         <div class="modal fade" id="edit<?php echo $r->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
           <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="editSubMenu" method="POST" enctype="multipart/form-data">
                    <div class="modal-header"> <h4 class="modal-title" id="myModalLabel">Edit subMenu Details</h4>
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="page" class="form-control" value="<?php echo $r->page; ?>">
                                  ...
                                  <div class="form-group">
                                <label>Menu</label>
                                <input type="text" name="menu_category" class="form-control" value="<?php echo $r->menu_category; ?>">
                            </div>
                             <div class="form-group">
                                <label>Sub Menu</label>
                                <input type="text" name="Menu_name" class="form-control" value="<?php echo $r->Menu_name; ?>">
                            </div>
...
<div class="modal fade" id="addDiscountCode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="addsubMenu" method="POST" enctype="multipart/form-data">
                <!--<input type="hidden" name="update" value="">-->
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add subMenu</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group" style="position: relative;">
                        <label>Page Name</label>
                    <input type="text" name="page" value="Home_page" readonly class="form-control">
                    </div>               
                   
                   
                   <div class="form-group">
                        <label>Menu </label>
                      <input class="form-control" name="menu_category" value="" type="text">
                    </div>
                     <div class="form-group">
                        <label>Sub Menu </label>
