...
foreach($row as $r){
           ...
           ?> 
                        ...
                        <tr> 
                        <td><img src="<?php echo base_url(); ?>images/04/<?php echo $r->img; ?>" style="height:80px; width:80px;" /></td>
            ...
            <form action="addTestimonial" method="POST" enctype="multipart/form-data">
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group" style="position: relative;">
                        <label>Text</label>
                    <textarea name="addTestimonialmsg" cols="" rows="" class="form-control"></textarea>
                    </div>               
                   
                   
                   <div class="form-group">
                        <label>Name </label>
                      <input class="form-control" name="addTestimonialName" value="" type="text">
                    </div>
