                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-1-1@m uk-inline">
                      ...
                      <!--<form action="Vendor/ToRegister" method="POST">           -->
                           ...
                           <form id="newvendorform" action="'.base_url().'Vendor/verifyOTP" method="POST"style="padding: 0px 0px 0px 40px;">
                              
                         <div class="uk-child-width-expand@s  uk-width-1-1@m" uk-grid style="padding:20px 0px; margin-left:0;" id="otphide">
                        
    <div style="padding:0px; " class="uk-child-width-expand@s  uk-width-1-1@m" uk-grid>
    <div style="padding:10px 5px;">
    
      <input name="email" type="email" placeholder="Enter Your Email" value="'.set_value('email').'"  style="background:transparent;" id="useremail_input">
 </div>
    <div style="padding:10px 5px; display:none;" id="otp">
   
      <input  name="otp" type="text" placeholder="Enter OTP"   style="background:transparent;" id="inputOtp" >
      </div>
  
       </div>
         <div style="padding:0px; margin-top:5px; " class="uk-child-width-expand@s  uk-width-1-2@m" uk-grid>
       
         <button  type="submit" id="clickbutton"  class="uk-button uk-button-small uk-button-primary uk-border-rounded" style="padding:5px 25px">Verify Otp<i class="fas fa-angle-right uk-margin-small-left"></i></button>
         <button  type="button" id="clickotp"  class="uk-button uk-button-small uk-button-primary uk-border-rounded" style="padding:5px 25px; display:none">Submit Otp<i class="fas fa-angle-right uk-margin-small-left"></i></button>
                      ...
                      <span style="color:red;">'.strip_tags(form_error('email')).'</span> 
        ...
        //         if(!empty(strip_tags(form_error('email')))){
        //             echo '         
        //   ';
        //         }
        //         else {}
 ...
 <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-inline">
                        <div class="uk-grid-medium uk-child-width-1-3@s uk-child-width-1-4@m uk-text-center uk-margin-medium-top" data-uk-grid>
                            <div>
                                <img src="http://demoaanaxagorasr.net/broker/brokerwhite/img/in-lazy.gif" data-src="http://demoaanaxagorasr.net/broker/brokerwhite/img/in-liquid-award.svg" alt="wave-award" width="71" height="58" data-uk-img>
