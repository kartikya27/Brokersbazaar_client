      ...
      <div class="row">
        ...
        <div class="col-md-7 contents" style="">
          <div class="row justify-content-center">
            ...
            <form action="<?php echo base_url() ?>Vendor/changePass" method="post">
            <p>
            <?php $msg = $this->session->flashdata('msg');
              ...
              <div class="form-group first">
                ...
                <input type="password" class="form-control" name="password" placeholder="Enter Your New Password" id="pass" required>
      <span style="color:red"></span>
              </div>

<div class="form-group first">
                <label for="username"></label>
                <input type="password" class="form-control" name="cpassword" placeholder="Confirm Password" id="newpass" required onkeyup="matchpassword(this,document.querySelector('#pass').value)">
      <span id="er" style="color:red"></span>
              </div>

              <input type="submit" value="Submit Password" class="btn text-white btn-block btn-primary" style="background-color:#29B6F6;border-color:#01579b;">
     
     <script>
         function matchpassword(ref,passvalue){
           let cpass = ref.value;
           let length = cpass.length;
           for(let i=0; i<length;i++){
               if(passvalue[i] !== cpass[i] || length !== passvalue.length){
               document.querySelector("#er").innerHTML="Password not matched";
               }else{
