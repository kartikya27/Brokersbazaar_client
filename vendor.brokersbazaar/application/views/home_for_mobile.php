...
<title>Mobile Verification | Vendor Registration</title>
...
<body>
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-1-1@m uk-inline">
                      ...
                      <!--<form action="Vendor/ToRegister" method="POST">           -->
                           ...
                           <form id="newvendorform" action="mobile_verify" method="POST"style="padding: 0px 0px 0px 00px;">
                              
                         <div class="uk-child-width-expand@s  uk-width-1-1@m" uk-grid style="padding:00px 40px; margin-left:0;" id="otphide">
    ...
    <div style="padding:10px 5px 10px 0px;" class=" uk-width-1-2@m">
      ...
      <input name="phone" type="text" placeholder="Enter Your Mobile" value="<?php echo set_value('phone');?>"  style="border-radius: 0px !important;width:100%;background:transparent;" id="userphone_input">
 </div>
    <div style="padding:10px 0px; display:none;" id="otp" class=" uk-width-1-2@m">
      ...
      <input  name="otp" type="text" placeholder="Enter OTP"   style="border-radius: 0px !important;background:transparent; width:100%" id="inputOtp" >
         ...
         <button  type="submit" id="clickbutton"  class="uk-button uk-button-small uk-button-primary uk-border-rounded" style="padding:5px 20px">Verify Mobile </button>
         <button  type="button" id="clickotp"  class="uk-button uk-button-small uk-button-primary uk-border-rounded" style="padding:5px 25px; display:none">Submit Otp<i class="fas fa-angle-right uk-margin-small-left"></i></button>
                      ...
                      <span id="msg1" style="color:red;"><?php echo strip_tags(form_error('phone'));?>'</span> 
...
$('#clickotp').click(function(){
               let otp = $('#inputOtp').val();
                 let phone=$('#userphone_input').val();
               
               $.ajax({
        url:"<?php echo base_url(); ?>Vendor/check_mobile_otp",
        method:"POST",
        ...
        success:function(data){
            ...
            if(data.substring(0,4) == "Done"){
                // document.getElementById('msg1').innerHTML = "OTP is  matched.";
                 window.location.href="<?php echo base_url();?>Vendor/ToRegister";
            }else {
