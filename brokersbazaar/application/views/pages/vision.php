                    ...
                    <div class="uk-flex uk-flex-left " >
                        ...
                        <div>
                            <h3><?php echo $pageContent->title; ?></h3>
                             ...
                             <div class="uk-panel">
    <img class="uk-align-left uk-margin-remove-adjacent" src="https://projects.letsgolive.in/admin.brokersbazaar/images/<?php echo $pageContent->img1; ?>" width="500" height="auto" alt="Example image">
